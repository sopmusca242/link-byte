    ...
    <body class="smartbg">
        ...
        <div class="smart-container">
            <div class="frm-header">
            	<h4><i class="fa fa-lock"></i> LinkByte </h4>
            </div><!-- end .frm-header section -->            
            <div class="frm-body">
                <div class="elem-group colm colm6">
                    <label class="field">
                        <input type="text" name="username" id="username" class="flo-input" placeholder="Identifiant">
                    </label>                            
                </div><!-- end .colm .elem-group section -->
                <div class="elem-group colm colm6">
                    <label class="field">
                        <input type="password" name="password" id="password" class="flo-input" placeholder="Mot de passe">
                    </label>                            
                </div><!-- end .colm .elem-group section -->
                <div class="response"></div><!-- end .response  section -->
            </div><!-- .frm-body -->
            <div class="frm-footer">
                <button type="submit" class="flo-button">Connexion</button>
